...
@section('title', '情報與營救｜游擊與抵抗')
@section('meta_description', '香港敵後的秘密營救路線、文化人撤離、盟軍情報合作與港九大隊在隱蔽戰線上的貢獻。')
            ...
            <div class="container top-padding-sm bottom-padding">
                <div class="row">
                    <div class="col-xl-6 col-lg-8 mx-auto">
                        ...
                        <p>秘密營救不只是軍事任務，也是文化和政治上的搶救。許多被困香港的文化人和民主人士，是當時中國抗戰輿論、出版、文藝和社會動員的重要力量。把他們救出香港，等於保存一批仍能繼續服務抗戰和國家未來的人才。這也使香港在中國抗戰中的角色，不只體現在戰場，也體現在保護文化力量之上。</p>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>情報工作表面上安靜，實際上極其危險。情報員可能要觀察日軍設施、記錄船隻出入、繪製地圖、拍攝或傳送資料；交通員則要把消息送到指定地點。任何一個環節出錯，都可能令整條交通線暴露。這些工作要求參與者冷靜、機警，也需要對同伴有高度信任。</p>
