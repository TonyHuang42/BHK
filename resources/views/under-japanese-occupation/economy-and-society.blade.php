...
>
    <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_section_1_title') }}</h6>
    ...
    <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_section_2_title') }}</h6>
    ...
    <x-slot:modal>
        <h6 class="content-subtitle mt-0">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_1_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_2_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_3_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_4_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_5_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_6_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_7_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_8_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_9_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_10_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_11_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('underJapaneseOccupation.japanese_occupation_rule.economy_model_section_12_title') }}</h6>
