...
>
    ...
    <x-slot:modal>
        <h6 class="content-subtitle mt-0">{{ __('peopleStories.people-and-stories.stoodUp_model_section_1_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_2_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_3_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_4_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_5_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_6_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_7_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_8_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_9_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_10_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_12_title') }}</h6>
        ...
        <p>{{ __('peopleStories.people-and-stories.stoodUp_model_section_12_p2') }}</p>
          ...
          <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_13_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_14_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.stoodUp_model_section_15_title') }}</h6>
