...
>
    <h6 class="content-subtitle">{{ __('guerrilla.guerrilla_warfare.hk_brigade_section_1_title') }}</h6>
    ...
    <x-slot:modal>
        <h6 class="content-subtitle mt-0">{{ __('guerrilla.guerrilla_warfare.hk_brigade_model_section_1_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('guerrilla.guerrilla_warfare.hk_brigade_model_section_3_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('guerrilla.guerrilla_warfare.hk_brigade_model_section_4_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('guerrilla.guerrilla_warfare.hk_brigade_model_section_5_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('guerrilla.guerrilla_warfare.hk_brigade_model_section_6_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('guerrilla.guerrilla_warfare.hk_brigade_model_section_7_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('guerrilla.guerrilla_warfare.hk_brigade_model_section_8_title') }}</h6>
