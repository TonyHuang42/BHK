...
>
    <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_section_1_title') }}</h6>
    <p>{{ __('peopleStories.people-and-stories.acts_section_1_p1') }}</p>
    <p>{{ __('peopleStories.people-and-stories.acts_section_1_p2') }}</p>

    <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_section_2_title') }}</h6>
    <p>{{ __('peopleStories.people-and-stories.acts_section_2_p1') }}</p>
    <p>{{ __('peopleStories.people-and-stories.acts_section_2_p2') }}</p>

     <x-slot:modal>
        <h6 class="content-subtitle mt-0">{{ __('peopleStories.people-and-stories.acts_model_section_1_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_model_section_2_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_model_section_3_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_model_section_4_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_model_section_5_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_model_section_6_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_model_section_7_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_model_section_8_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_model_section_9_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_model_section_10_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_model_section_11_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('peopleStories.people-and-stories.acts_model_section_12_title') }}</h6>
