...
>
    ...
    <h6 class="content-subtitle">{{ __('battle.before_storm.battle_process_section_1_title') }}</h6>
    <p>{{ __('battle.before_storm.battle_process_section_1_p1') }}</p>
    <p>{{ __('battle.before_storm.battle_process_section_1_p2') }}</p>

    <h6 class="content-subtitle">{{ __('battle.before_storm.battle_process_section_2_title') }}</h6>
    <p>{{ __('battle.before_storm.battle_process_section_2_p1') }}</p>
    <p>{{ __('battle.before_storm.battle_process_section_2_p2') }}</p>

    <x-slot:modal>
        <h6 class="content-subtitle mt-0">{{ __('battle.before_storm.battle_process_model_section_1_title') }}</h6>
        ...
        <h6 class="content-subtitle">{{ __('battle.before_storm.battle_process_model_section_2_title') }}</h6>
